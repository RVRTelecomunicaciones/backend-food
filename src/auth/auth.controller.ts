import { Controller, Post, UseGuards, Body, ValidationPipe, Get, Req, Query, Res, Param } from '@nestjs/common';
...
import { CreateUserDto } from 'src/system/users/dto/create-user.dto';
...
export class AuthController {
  ...
  @Post('v1/auth/signup')
  async singUp(@Body() createUserDto: CreateUserDto): Promise<{ accessToken: string }> {
