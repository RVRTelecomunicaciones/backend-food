                            ...
                            <tbody>
                                <tr>
                                    <td align="left" style = "box-sizing:border-box;padding:0;font-family:\'Open Sans\',\'Helvetica Neue\',\'Helvetica\',Helvetica,Arial,sans-serif;font-size:16px;vertical-align:top;text-align:left" valign = "top" >
                                        <span>
                                            <a href="--ProjectLink--" style = "box-sizing:border-box;color:--ProjectColor--;font-weight:400;text-decoration:none" target = "_blank" > <img alt="--ProjectName--" height = "70" src = "--ProjectLogo--" style = "max-width:100%;border-style:none;height:75px;width:85px" width = "80" />
                                            </a>
                                        </span >
                                    </td>
                                </tr >
                                                ...
                                                <tr>
                                                    <td style="box-sizing:border-box;padding:0;font-family:\'Open Sans\',\'Helvetica Neue\',\'Helvetica\',Helvetica,Arial,sans-serif;font-size:16px;vertical-align:top" valign="top" >
                                                        <h2 style="margin:0;margin-bottom:30px;font-family:\'Open Sans\',\'Helvetica Neue\',\'Helvetica\',Helvetica,Arial,sans-serif;font-weight:300;line-height:1.5;font-size:24px;color:#294661!important" >
                                                            Hey --PersonName-- 👋,<br/ > Did you forget your <b> --ProjectName--</b> password?<br/ > Let\'s reset your password. </h2>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="box-sizing:border-box;padding:0;font-family:\'Open Sans\',\'Helvetica Neue\',\'Helvetica\',Helvetica,Arial,sans-serif;font-size:16px;vertical-align:top" valign="top" >
                                                                ...
                                                                <tr>
                                                                    <td align="center" style="box-sizing:border-box;padding:0;font-family:\'Open Sans\',\'Helvetica Neue\',\'Helvetica\',Helvetica,Arial,sans-serif;font-size:16px;vertical-align:top;padding-bottom:15px" valign="top" >
                                                                        <table cellpadding="0" cellspacing="0" style="box-sizing:border-box;border-spacing:0;width:auto;border-collapse:separate!important" >
                                                                            <tbody>
                                                                                <tr> <td align="center" bgcolor="--ProjectColor--" style="box-sizing:border-box;padding:0;font-family:\'Open Sans\',\'Helvetica Neue\',\'Helvetica\',Helvetica,Arial,sans-serif;font-size:16px;vertical-align:top;background-color:--ProjectColor--;border-radius:20px;text-align:center" valign="top" >
                                                                                    <a href="--ButtonLink--" style="box-sizing:border-box;border-color:--ProjectColor--;font-weight:400;text-decoration:none;display:inline-block;margin:0;color:#ffffff;background-color:--ProjectColor--;border:solid 1px --ProjectColor--;border-radius:20px;font-size:14px;padding:12px 45px" target="_blank" >Cambiar Contraseña</a>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                            ...
                            <tr style="font-size:12px">
                                <td align="center" style="box-sizing:border-box;font-family:\'Open Sans\',\'Helvetica Neue\',\'Helvetica\',Helvetica,Arial,sans-serif;vertical-align:top;font-size:12px;text-align:center;padding:20px 0" valign="top" >
                                    <span style="float:none;display:block;text-align:center" >
                                        <a href="--ProjectLink--" style="box-sizing:border-box;color:--ProjectColor--;font-weight:400;text-decoration:none;font-size:12px" target="_blank" >
                                            <img alt="--ProjectName--" height="20" src="--ProjectLogo--" style="max-width:100%;border-style:none;font-size:12px;height:20px;width:91px" width="91"/>
                                        </a >    
                                    </span>
                                        <p style="color:#294661;font-family:\'Open Sans\',\'Helvetica Neue\',\'Helvetica\',Helvetica,Arial,sans-serif;font-size:12px;font-weight:400;margin-bottom:5px;margin:10px 0 20px" > --ProjectSlogan-- </p>
                                        <p style="margin:0;color:#294661;font-family:\'Open Sans\',\'Helvetica Neue\',\'Helvetica\',Helvetica,Arial,sans-serif;font-weight:300;font-size:12px;margin-bottom:5px" > © --ProjectName-- --ProjectAddress-- </p>
                                        <p style="margin:0;color:#294661;font-family:\'Open Sans\',\'Helvetica Neue\',\'Helvetica\',Helvetica,Arial,sans-serif;font-weight:300;font-size:12px;margin-bottom:5px" > --Socials-- </p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
